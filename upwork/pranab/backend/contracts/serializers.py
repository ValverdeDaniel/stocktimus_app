...
class SavedContractSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'initial_equity_invested', 'current_equity_value',
            'first_added_to_group_date', 'last_reset_date', 'last_refresh_date',
            'created_at', 'dynamic_days_to_gain', 'days_until_expiration',
    ...
    def get_underlying_percent_change(self, obj):
        return round(obj.underlying_percent_change(), 2)
    
    def get_premium_percent_change(self, obj):
        return round(obj.premium_percent_change(), 2)
    
    def get_equity_percent_change(self, obj):
        return round(obj.equity_percent_change(), 2)
